    ...
    <section>
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center justify-center px-20">
          <strong>
            <h1 className="text-4xl py-2 text-green-400"><BoxReveal BoxReveal boxColor={"#66bb6a"} duration={1}>WHO AM I</BoxReveal></h1>
          </strong>

          <h1 className="lg:text-5xl md:text-2xl text-lg font-bold pt-10">
            <BoxReveal boxColor={"#66bb6a"} duration={1}>I&apos;m John Lorenz Eldon R. Masa</BoxReveal>
            
          </h1>

          <h1 className="lg:text-2xl text-base py-5 lg:w-[60vw] w-[80vw] text-center">
          <BoxReveal BoxReveal boxColor={"#66bb6a"} duration={1}>A graduate of Bachelor of Science in Information Technology. And
            ...
            Technology.</BoxReveal>
            
          </h1>
         
          <h1 className="lg:text-2xl text-base py-5 lg:w-[60vw] w-[80vw] text-center">
          <BoxReveal BoxReveal boxColor={"#66bb6a"} duration={1}>I&apos;m Also a former Member of the student body back in my college
            ...
            during their college years.</BoxReveal>
