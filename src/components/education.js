        ...
        <div className="flex flex-col items-center justify-center px-20">
          <strong>
            <TextAnimate
              animation="blurIn"
              as="h1"
              className={"text-4xl py-2 text-green-400"}
            >
              WHO AM I
            </TextAnimate>
          </strong>
          ...
          <BlurFade delay={0.25} inView>
            <h1 className="lg:text-2xl text-base py-5 lg:w-[60vw] w-[80vw] text-center">
              ...
              myself how does a computer works? How does a computer understand
            ...
            <h1 className="lg:text-2xl text-base py-5 lg:w-[60vw] w-[80vw] text-center">
              ...
              back in 2017 for a year focus on creating events for the students
              to enjoy their stay during their college years.
            </h1>
          </BlurFade>
        </div>
      </div>
