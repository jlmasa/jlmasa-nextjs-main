    ...
    <section>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <h1 className="lg:text-4xl md:text-3xl px-16 lg:px-20 md:px-9 lg:w-screen dark:text-gray-300  text-black pb-10 text-center">
          I am located in Laguna/makati and
          i like to build amazing UI/UX experience for people. 
          Currently, I&apos;m more focus on developing systems and technologies 
          that will make life easier for people as a fullstack developer.
        </h1>
        <motion.div
